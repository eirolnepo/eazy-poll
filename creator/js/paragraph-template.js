...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function handleParagraphAnswer(questionDiv) {
        const choicesContainer = questionDiv.querySelector(".question-choices-container");

        const paragraphDiv = document.createElement("div");
        paragraphDiv.classList.add("choice-container");
        ...
        paragraphDiv.appendChild(paragraphTextarea);
        choicesContainer.appendChild(paragraphDiv);
    ...
    function addQuestion() {
        ...
        questionCounter++;
        handleParagraphAnswer(questionDiv);
        updateImagesForDarkMode();
